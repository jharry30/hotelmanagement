...
textarea {
    width: 100%;
    padding: 0.8rem; /* Adjusted padding for better spacing */
...
.submit-button {
    ...
    color: white;
    padding: 0.8rem; /* Adjusted padding for better button size */
    border: none;
    border-radius: 5px;
    cursor: pointer;
    font-size: 1rem;
...
<script>
    function enableEditing() {
        // Enable editing for the input fields
...
<body>
    ...
    <div class="main-container">
        <div class="main-title">
            <h3 class="font-weight-bold" style="margin: 0;">Your Profile</h3>
        ...
        <form class="profile-form">
            ...
            <div class="form-group">
                ...
                <input type="tel" id="phone" name="phone" value="0917-123-4567" >
            </div>

            <div class="form-group">
                <label for="address">Address:</label>
                <input type="text" id="address" name="address" value="123 Main Street, City" >
            </div>

            <div class="form-group">
                <button type="button" class="submit-button">Save Changes</button>
            </div>
        </form>
