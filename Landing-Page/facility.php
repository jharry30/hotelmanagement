    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto p-4 p-lg-0">
                    ...
                    <a href="facility.php" class="nav-item nav-link active">Facilities</a>
...
<br>
 <h1 class="text-center mb-5 wow fadeInUp" data-wow-delay="0.1s">Facility</h1>  
            ...
            <div class="row g-4">
                <div class="col-md-6">
                    <div class="card text-center">
                        <div class="card-body">
                            ...
                            <p class="card-text">Enjoy a wide variety of cuisines and refreshments in our cozy cafe.</p>
                ...
                <div class="col-md-6">
                    <div class="card text-center">
                        <div class="card-body">
                            ...
                            <p class="card-text">Perfect for events and gatherings with modern amenities.</p>
                            <a href="#" class="btn btn-primary">Book Now</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="card text-center">
                        <div class="card-body">
                            <h5 class="card-title">Datu Hall</h5>
                            <p class="card-text">A spacious hall ideal for larger events and conferences.</p>
                            <a href="#" class="btn btn-primary">Book Now</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="card text-center">
                        <div class="card-body">
                            <h5 class="card-title">David Hall</h5>
                            <p class="card-text">An elegant space designed for intimate gatherings and celebrations.</p>
                            <a href="#" class="btn btn-primary">Book Now</a>
                        </div>
                    </div>
                </div>
