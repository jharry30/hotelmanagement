...
.room-card {
    ...
    margin: 10px;
    width: calc(40% - 20px); /* Smaller card size for three cards per row */
    text-align: center;
...
.book-button {
    background-color: #25316D; /* Yellow color */
    color: white;
    border: none;
    border-radius: 5px;
...
.book-button:hover {
    background-color: #198754; /* Darker shade on hover */
}
...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
        ...
        <div class="cards-container">
            ...
            <!-- Datu Hall -->
            <div class="room-card" data-category="datu-hall">
